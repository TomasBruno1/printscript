...
class SolverVisitorTest {
    ...
    public void test002_WhenReceivingAdditionAndMultiplicationOperationShouldReturnCorrectResult() {
        Expression input = new Expression(new Variable("1"), Operand.SUM, new Expression(new Variable("2"), Operand.MUL, new Variable("3")));
        String expected = "7";
        SolverVisitor visitor = new SolverVisitor();
        input.accept(visitor);
        String actual = visitor.result;
    ...
    public void test003_WhenReceivingComplexNumericalOperationShouldReturnCorrectResult() {
        Expression input = new Expression(new Expression(new Variable("5"), Operand.DIV, new Variable("2")), Operand.SUM, new Expression(new Variable("2"), Operand.MUL, new Expression(new Variable("3"), Operand.SUB, new Variable("4"))));
        String expected = "0.5";
        SolverVisitor visitor = new SolverVisitor();
        input.accept(visitor);
        String actual = visitor.result;
    ...
    public void test005_WhenReceivingComplexNumberAndVariableOperationShouldReturnCorrectResult() {
        Expression input = new Expression(new Expression(new Variable("aNumber"), Operand.DIV, new Variable("2")), Operand.SUM, new Expression(new Variable("2"), Operand.MUL, new Expression(new Variable("anotherNumber"), Operand.SUB, new Variable("4"))));
        String expected = "0.5";
    ...
    public void test007_WhenReceivingStringConcatenationWithVariableShouldReturnCorrectResult() {
        Expression input = new Expression(new Variable("'Hello'"), Operand.SUM, new Expression(new Variable("aString"), Operand.SUM, new Variable("\"!!!\"")));
        String expected = "\"Hello world!!!\"";
    ...
    public void test008_WhenReceivingStringConcatenationWithNumberShouldReturnCorrectResult() {
        Expression input = new Expression(new Variable("'Hello'"), Operand.SUM, new Expression(new Variable("5.12"), Operand.SUM, new Variable("\"!!!\"")));
    ...
    public void test009_WhenReceivingStringsNumbersAndVariablesOperationShouldReturnCorrectResult() {
        Expression input = new Expression(new Expression(new Variable("'Hello'"), Operand.SUM, new Variable("\" world!\"")), Operand.SUM, new Expression(new Expression(new Variable("5.5"), Operand.MUL, new Variable("2")), Operand.SUM, new Variable("aString")));
