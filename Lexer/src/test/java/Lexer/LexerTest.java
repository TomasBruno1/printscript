...
class LexerTest {
    ...
    public void identifierLexerTest() {
        List<Token> tokens =
                List.of(
                        new Token(
                                DefaultTokenTypes.IDENTIFIER, 1, 18, new LexicalRange(1, 0, 18, 0)),
                        new Token(
    ...
    public void integrationLexerTest() {
        List<Token> tokens =
                List.of(
                        new Token(DefaultTokenTypes.KEYWORD, 0, 3, new LexicalRange(0, 0, 3, 0)),
                        new Token(
                                DefaultTokenTypes.IDENTIFIER, 4, 12, new LexicalRange(4, 0, 12, 0)),
                        new Token(
                        ...
                        new Token(
                                DefaultTokenTypes.KEYWORD, 14, 20, new LexicalRange(14, 0, 20, 0)),
                        new Token(DefaultTokenTypes.ASSIGN, 21, 22, new LexicalRange(21, 0, 22, 0)),
                        new Token(
                                DefaultTokenTypes.LITERAL, 23, 37, new LexicalRange(23, 0, 37, 0)),
                        new Token(
                                DefaultTokenTypes.SEPARATOR,
                                37,
                                38,
                        ...
                        new Token(
                                DefaultTokenTypes.IDENTIFIER, 44, 47, new LexicalRange(4, 1, 7, 1)),
                        new Token(
                                DefaultTokenTypes.SEPARATOR, 47, 48, new LexicalRange(7, 1, 8, 1)),
                        ...
                        new Token(
                                DefaultTokenTypes.LITERAL, 55, 56, new LexicalRange(15, 1, 16, 1)),
                        new Token(
                                DefaultTokenTypes.OPERATOR, 56, 57, new LexicalRange(16, 1, 17, 1)),
                        new Token(
                                DefaultTokenTypes.LITERAL, 57, 60, new LexicalRange(17, 1, 20, 1)),
                        new Token(
                                DefaultTokenTypes.SEPARATOR,
                                60,
                                61,
    ...
    public void integrationLexerTest2() {
        List<Token> tokens =
                List.of(
                        ...
                        new Token(
                                DefaultTokenTypes.SEPARATOR, 21, 22, new LexicalRange(1, 1, 2, 1)),
                        ...
                        new Token(
                                DefaultTokenTypes.LITERAL, 32, 41, new LexicalRange(12, 1, 21, 1)),
                        new Token(
                                DefaultTokenTypes.IDENTIFIER, 44, 52, new LexicalRange(1, 2, 9, 2)),
